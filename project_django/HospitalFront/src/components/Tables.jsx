              ...
              <div className="flex items-center gap-4">
                <span className="w-12">
                  <img
                    src={item.user.image}
                    alt={item.user.title}
                    className="object-cover w-full h-12 border rounded-full border-border"
                  />
                </span>
            ...
            {action && (
              <td className={tdclass}>
                <MenuSelect datas={DropDown1} item={item}>
                  <div className="px-4 py-2 text-xl border rounded-lg bg-dry text-main">
    ...
    <table className="w-full table-auto">
      <thead className="overflow-hidden rounded-md bg-dry">
        <tr>
          ...
          <th className={thclasse}>Genero</th>
          <th className={thclasse}>Telefono</th>

          <th className={thclasse}>Acciones</th>
        </tr>
      </thead>
      <tbody>
        {data.map((item, index) => (
          ...
          >
            ...
            <td className={tdclasse}>
              <div className="flex items-center gap-4">
                {!used && (
                  <span className="w-12">
                    <img
                      src="https://imgv3.fotor.com/images/share/fotor-ai-generate-a-lifelike-dragon.jpg"
                      alt={item.fullName}
                      className="object-cover w-full h-12 border rounded-full border-border"
                    />
                  </span>
            ...
            <td className={tdclasse}>{item.bornDate}</td>

            <td className={tdclasse}>
              <span
                className={`py-1 px-4 ${
                  item.genre === 'Masculino'
                    ? 'bg-subMain text-subMain'
                    : 'bg-orange-500 text-orange-500'
                } bg-opacity-10 text-xs rounded-xl`}
              >
            ...
            <td className={tdclasse}>{item.phoneNumber}</td>
            <td className={tdclasse}>
              <MenuSelect datas={DropDown1} item={item}>
                <div className="px-4 py-2 text-xl border rounded-lg bg-dry text-main">
                  <BiDotsHorizontalRounded />
          ...
          >
            ...
            <td className={tdclass}>
              <button
                ...
                className="w-10 h-10 text-sm bg-white border rounded-md flex-colo text-subMain"
              >
                <FiEye />
              </button>
            </td>
            ...
            {button && (
              <td className={tdclass}>
                <button
                  ...
                  className="px-4 py-3 text-sm text-red-600 bg-red-600 border border-red-100 rounded-lg bg-opacity-5"
                >
                  <RiDeleteBinLine />
                </button>
              </td>
          ...
          >
            ...
            {!doctor && (
              <td className={tdclass}>
                <Link
                  ...
                  className="text-xs underline text-subMain"
                >
            ...
            <td className={tdclass}>
              <div className="px-2 py-4 border rounded-lg">
                <p className="text-xs text-textGray lg:text-wrap">
                  {item.comment}
                </p>
              </div>
            </td>
